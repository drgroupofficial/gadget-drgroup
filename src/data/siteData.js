...
export const site = {
  ...
  logo: import.meta.env.BASE_URL + "assets/logo-resmi.png",
  ogImage: import.meta.env.BASE_URL + "assets/og-image.svg",
...
export const stores = [
  {
    ...
    photo: import.meta.env.BASE_URL + "assets/foto-almira-gadget.jpg",
    logo: import.meta.env.BASE_URL + "assets/logo-almira-resmi.png",
  ...
  },
  {
    ...
    operatingDays: "Senin - Minggu",
    operatingHours: "10.00 - 23.00 WIB (Jumat 14.00 - 23.00 WIB)",
    photo: import.meta.env.BASE_URL + "assets/foto-drstore-sidoarjo.jpg",
    logo: import.meta.env.BASE_URL + "assets/logo-drstore-sidoarjo-resmi.png",
    services: ["beli", "jual", "tukar-tambah", "konsultasi"],
    status: "Buka setiap hari",
  },
  {
    ...
    operatingDays: "Senin - Minggu",
    operatingHours: "10.00 - 23.00 WIB (Jumat 14.00 - 23.00 WIB)",
    photo: import.meta.env.BASE_URL + "assets/foto-drstore-tropodo.jpg",
    logo: import.meta.env.BASE_URL + "assets/logo-drstore-tropodo-resmi.png",
    services: ["beli", "jual", "tukar-tambah", "konsultasi"],
    status: "Buka setiap hari",
  },
];
